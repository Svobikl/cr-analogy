...
Semantic questions are divided into 9 group, each having around 30 - 100 word question pairs. Combination of question pairs gives overall 36,880 semantics questions:  
...
\begin{itemize}
	\item[-] jobs
	\item[-] adjective-to-adverb
	\item[-] opposite
	\item[-] comparative
	\item[-] superlative
	\item[-] nationality-man
	\item[-] nationality-female
	\item[-] past-tense
	\item[-] plural
	\item[-] nouns-antonyms
	\item[-] adjectives-antonyms
	\item[-] verbs-antonyms
	\item[-] verbs-pastToFemale
	\item[-] verbs-pastToMale
\end{itemize}
...
\begin{table}[!h]
	\begin{center}
		\begin{tabularx}{\columnwidth}{|l|X|X|X|X|}
			...
			\hline
			\bf{Model}&\bf{CBOW}&\bf{Skip}&\bf{fastText-Skip}&\bf{fastText-CBOW}\\
			\hline
	...
	\begin{center}
		\begin{tabularx}{\columnwidth}{|l|ccc|}
			...
			& \multicolumn{3}{c|}{\bf Croatian}\\
			 CBOW& xy& xy & 32.03 (19.19)\\
			 Skip-gram& xy& xy & 33.89 (20.31)\\
			 fastText-Skip& xy& xy & 43.83 (25.79)\\
			 fastText-CBOW& xy& xy & 43.14 (25.79)\\
			\hline
